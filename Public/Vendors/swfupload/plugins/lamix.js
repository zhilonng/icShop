...
/**
 * @author 林坤源
 * @version 2.5 最后修改时间 2013年11月08日
 * 翻译请参照 PHP100的http://bbs.php100.com/read-htm-tid-25606.html
 */
...
function preLoad() {
	if (!this.support.loading) {
		alert("您的浏览器需要安装 Flash Player 9.028 或以上版本才使用上传功能.");
		return false;
	}
}
function loadFailed() {
...
function queueComplete(numFilesUploaded) {
	...
	status.innerHTML = numFilesUploaded + " 个文件已上传。您可以继续上传或返回列表页";
}



var swfusettings = {
	flash_url : "/Public/Vendors/swfupload/plugins/swfupload.swf",
	flash9_url : "/Public/Vendors/swfupload/plugins/swfupload_fp9.swf",
	upload_url: "/Public/Vendors/swfupload/upload.php",
	...
	custom_settings : {
		...
		cancelButtonId : "btnCancel"  //必须要确保该取消按钮的存在！！！！！！！
	},
	debug: false,

	// Button settings
	button_image_url: "/Public/Vendors/swfupload/images/TestImageNoText_65x29.png",
	button_width: "120",
	button_height: "24",
	...
	upload_success_handler : uploadSuccess, // 上传单个图片完成后的回调函数
	upload_complete_handler : uploadComplete,
	queue_complete_handler : queueComplete	// 批量上传图片队列完成后的回调函数
};