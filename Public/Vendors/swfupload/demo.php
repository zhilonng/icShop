...
window.onload = function() {
	var settings = {
		flash_url : "plugins/swfupload.swf",
		flash9_url : "plugins/swfupload_fp9.swf",
		upload_url: "demoact.php",
...
<body>
<div id="header">
	<h1 id="logo"><a href="http://swfupload.googlecode.com" target="_blank">SWFUpload</a></h1>
	<div id="version">v2.5.0</div>
</div>

<div id="content">
	<h2>Simple Demo</h2>
	<form id="form1" action="demoact.php" method="post" enctype="multipart/form-data">
